...
- [Node.java]() class file
- [Path.java]() class file

###HOMEWORK:
**Assignments**:
- if you did the **Pokeball** class definition on paper in class, do the **Trainer** class definition on paper and place it in my pigeonhole before the next class
- if you did the **Trainer** class definition on paper in class, do the **Pokeball** class definition on paper and place it in my pigeonhole before the next class
...
**Prep for Next Class**:
- Follow the instructions in the  [SETUP_and_WORKFLOW.md](https://github.com/alyeffy/AP-CS-A_2018-2019/blob/master/SETUP_and_WORKFLOW.md) file to set up the development environment and workflow needed for the course. If you encounter any problems, make sure to comment on the [topic issue](https://github.com/alyeffy/AP-CS-A_2018-2019/issues/1).
