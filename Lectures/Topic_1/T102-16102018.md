...
- The image below shows how to convert decimal to binary and vice versa, and binary to hex and vice versa:
...
- using the decimal/binary/hex conversion methods learned in class, complete on paper, **showing all your steps**, the conversions of the following:

- remember to drop them off in my pigeonhole

**Prep for Next Class**:
- keep working at the Eclipse and GitHub setup, and we will go through any setup issues for a bit at the beginning of the next class
