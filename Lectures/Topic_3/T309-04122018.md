# LESSON 09 - TOPIC 3: The Software Development Life Cycle (SLDC)
...
As a **programmer/software developer**, you should be able to manage the **Software Development Life Cycle (SLDC)**:
...
The SLDC exists in several different models, such as the following:
- **Protoyping**
